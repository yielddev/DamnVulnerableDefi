...
describe('[Challenge] Unstoppable', function () {
    ...
    it('Execution', async function () {
        ...
        // totalAssets() returns the ERC20.balanceOf the vault 
        // by increaseing the the balance (totalAssets) without increasing the number of shares
        // we can brick the convertToShares(totalSupply) != balanceBefore check
